      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <dl className="mt-8 space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <dt className="text-sm font-medium text-white">Phone / Text</dt>
                    <dd className="mt-0.5 text-sm text-gray-400">
                      <a href="tel:+12082848573" className="hover:text-gold-400">
                        (208) 284-8573
                      </a>
                    </dd>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <dd className="mt-0.5 text-sm text-gray-400">
                      <a href="mailto:hello@legrouprealty.com" className="hover:text-gold-400">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <dt className="text-sm font-medium text-white">Service Area</dt>
                    <dd className="mt-0.5 text-sm text-gray-400">
            ...
            {/* Right column — form */}
            <div className="relative rounded-xl border border-neutral-800 bg-neutral-900 p-6 shadow-md lg:p-8">
