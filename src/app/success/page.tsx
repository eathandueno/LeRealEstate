  ...
  return (
    <section className="flex min-h-[60vh] items-center justify-center py-16 sm:py-20">
      <div className="mx-auto max-w-md px-4 text-center sm:px-6">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-navy-800">Thank You!</h1>
        <p className="mt-3 text-lg text-navy-500">
          Your message has been received. We&apos;ll reach out within 1 business day.
        </p>
        <Link
          href="/"
          className="mt-8 inline-flex rounded-lg bg-gold-500 px-6 py-3 text-sm font-semibold text-navy-900 shadow-sm transition-all hover:bg-gold-400 hover:shadow-md"
        >
          Back to Home
        </Link>
      </div>
